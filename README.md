...
1. Top 5 category trend and YoY movement
2. Whether top 2025 stores are driven by statewide top categories or local outliers
3. Where top stores are geographically and which category-size-brand mix is most profitable
4. Which low-performing SKUs are candidates for removal to free shelf space
