...
Key Findings:
1. #1 store HY-VEE#3, has Tequila as most selling category, giving 1.8m sales. The most selling size is 750ml bottle for Patron Silver.
2. Central City 2 also have highest selling 750ml Tequilas, where the most popular brand item is Patron Silver
3. For 1st two ranked stores, Canadian Whiskies were performing worst. However, at Another Round store, Tennessee whiskies are generating lowest revenue.
4. HY-VEE WINE AND SPIRITS is the only store with highest revenue from Bourbon whiskies and Tequila is 3rd popular
